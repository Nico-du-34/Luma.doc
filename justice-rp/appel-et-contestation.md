...
Cette page explique un élément de la procédure judiciaire RP. La justice doit apporter un cadre lisible, protéger les droits des joueurs et donner une suite cohérente aux scènes.

### Règles principales

* expliquer la décision contestée
* apporter des éléments nouveaux ou une erreur claire
* respecter les délais annoncés
* attendre la réponse sans relancer abusivement
...
Contester ne suspend pas toujours la sanction.
